...
//                         {item.audioPreviewUrl || item.previewUrl ? (
//                           <audio
//                             ref={standaloneAudioRef}
//                             key={item.audioPreviewUrl || item.previewUrl}
//                             src={item.audioPreviewUrl || item.previewUrl}
//                             controls
//                             preload="metadata"
...
//                         <video
//                           ref={videoRef}
//                           key={`${item.previewUrl}-${item.audioPreviewUrl || ""}`}
//                           src={item.previewUrl}
...
//                         {item.audioPreviewUrl && item.hasAudio === false && (
//                           <audio
//                             ref={audioRef}
//                             key={item.audioPreviewUrl}
...
//                       This preview uses the saved media link from your recent
//                       download. Some platforms can expire preview links after a
//                       while.
//                     </p>
//                   </div>
