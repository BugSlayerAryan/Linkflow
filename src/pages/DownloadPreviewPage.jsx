...
//   /**
//    * Important:
//    * Use backend preview route for video preview.
//    * Raw X.com/Twitter CDN URLs often fail in browser.
//    */
//   const selectedPreview =
//     format === "video" ? videoInfo?.previewUrl || "" : "";
...
function DownloadPreviewPage() {
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      const selectedHasAudio = hasConfirmedAudio(selectedMedia);
      ...
      const downloadMeta = {
        ...
        platform: videoInfo?.platform || platform,
        durationText: videoInfo?.durationText || "--",
        previewUrl: format === "video" ? selectedPreview || "" : "",
        audioPreviewUrl: format === "audio" ? selectedMedia?.url || "" : "",
