...
//   {
//     title: "Product",
//     links: ["Features", "How It Works", "Formats", "Pricing"],
//   },
//   {
//     title: "Company",
//     links: ["About Us", "Blog", "Contact Us", "Careers"],
//   },
//   {
//     title: "Legal",
//     links: ["Privacy Policy", "Terms of Service", "Refund Policy", "DMCA"],
//   },
//   {
//     title: "Support",
//     links: ["Help Center", "Report Issue", "Contact Us"],
//   },
// ];
...
//   return (
//     <div>
//       <h3 className="text-[13.5px] font-semibold tracking-[-0.01em] text-white sm:text-[14px]">
//         {title}
//       </h3>
...
//             <a
//               href="#"
//               className="text-[12.5px] font-medium text-slate-400 transition duration-300 hover:text-white sm:text-[13px]"
//             >
//               {link}
//             </a>
//           </li>
...
//     <footer
//       id="contact"
//       className="relative overflow-hidden border-t border-white/[0.06] bg-[#030712] px-5 py-10 sm:px-8 sm:py-14 lg:px-14 lg:py-16 xl:px-20"
//     >
//       <div className="pointer-events-none absolute left-1/2 top-0 h-56 w-[320px] -translate-x-1/2 rounded-full bg-violet-600/8 blur-[90px] sm:w-[520px]" />
//       <div className="pointer-events-none absolute bottom-0 right-0 h-64 w-64 rounded-full bg-blue-600/5 blur-[100px]" />

//       <div className="relative mx-auto max-w-[1440px]">
//         <div className="grid gap-8 lg:grid-cols-[1.35fr_2fr_1.35fr] lg:gap-10">
//           <div className="max-w-[360px]">
//             <Logo />

//             <p className="mt-4 max-w-[340px] text-[13px] leading-6 text-slate-400 sm:mt-5 sm:text-[14px] sm:leading-7">
...
//                   className="grid h-9 w-9 place-items-center rounded-xl border border-white/10 bg-white/[0.04] transition duration-300 hover:-translate-y-0.5 hover:border-violet-400/35 hover:bg-violet-500/10 sm:h-10 sm:w-10"
//                 >
//                   <BrandLogo
//                     name={social.name}
...
//           <div className="grid grid-cols-2 gap-x-8 gap-y-7 sm:grid-cols-4 lg:gap-x-10">
...
//             <p className="mt-3.5 max-w-[340px] text-[13px] leading-6 text-slate-400 sm:mt-4 sm:text-[14px]">
//               Subscribe to get product updates and helpful download tips.
//             </p>

//             <form className="mt-4 flex h-11 w-full max-w-[360px] overflow-hidden rounded-2xl border border-white/10 bg-white/[0.04] transition duration-300 focus-within:border-violet-400/40 sm:mt-5 sm:h-12">
//               <input
//                 type="email"
//                 className="min-w-0 flex-1 bg-transparent px-4 text-[13px] text-white outline-none placeholder:text-slate-500 sm:text-sm"
//                 placeholder="Enter your email"
//               />

//               <button
//                 type="submit"
//                 className="grid w-12 shrink-0 place-items-center bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white transition duration-300 hover:brightness-110 sm:w-[52px]"
...
//         <div className="mt-9 border-t border-white/[0.08] pt-5 sm:mt-10 lg:mt-12">
//           <div className="flex flex-col gap-3 text-[12.5px] text-slate-400 sm:flex-row sm:items-center sm:justify-between sm:text-[13px]">
//             <p>&copy; 2026 LinkFlow Downloader. All rights reserved.</p>

//             <div className="flex flex-wrap items-center gap-x-4 gap-y-2 text-slate-500 sm:justify-end sm:gap-x-5">
...
//           <p className="mt-3 text-[12px] text-slate-600 sm:text-right">
